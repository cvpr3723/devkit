...
from auxiliary.visualizers import VisibilityVisualizer
...
def parse_args() -> Dict[str, Path]:
  ...
  parser.add_argument("--pred_dir", required=True, type=Path, help='Path to dir containing predictions') # in this case visibility
